'use strict';
const CACHE_NAME = 'pubic-static-blog-v6';
const STATIC_CACHE_NAME = 'static-assets-v25';
const IMAGE_CACHE_NAME = 'images-v11';
const CONTENT_CACHE_NAME = 'blog-content-v7';
