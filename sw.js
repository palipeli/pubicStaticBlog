'use strict';
const CACHE_NAME = 'pubic-static-blog-v7';
const STATIC_CACHE_NAME = 'static-assets-v26';
const IMAGE_CACHE_NAME = 'images-v12';
const CONTENT_CACHE_NAME = 'blog-content-v8';
